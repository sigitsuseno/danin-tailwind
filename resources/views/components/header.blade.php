<header id="header_depan" class="container p-2 mx-auto md:px-0">
        ...
        <div class="flex gap-4">
            ...
            <ul
                ...
                <li class="flex items-center h-14">
                    <a href="pie-susu.html"
                        class="px-3 py-2 hover:bg-[brown] transition duration-500 rounded-lg block w-full hover:text-white">Pie
                        Susu
                        Danin</a>
                </li>
                <li class="flex items-center h-14">
                    <a href="#"
                        class="px-3 py-2 hover:bg-[brown] transition duration-500 rounded-lg block w-full hover:text-white">Special</a>
                </li>
                <li class="flex items-center h-14">
                    <a href="#"
                        class="px-3 py-2 hover:bg-[brown] transition duration-500 rounded-lg block w-full hover:text-white">Roti
                        Kering</a>
                </li>
                <li class="flex items-center h-14">
                    <a href="#"
                        class="px-3 py-2 hover:bg-[brown] transition duration-500 rounded-lg block w-full hover:text-white">Jajanan</a>
                </li>
                <li class="flex items-center h-14">
                    <a href="#"
                        class="px-3 py-2 hover:bg-[brown] transition duration-500 rounded-lg block w-full hover:text-white">Danin
                        Store</a>
                </li>
                <li class="flex items-center h-14">
                    <a href="#"
                        class="px-3 py-2 hover:bg-[brown] transition duration-500 rounded-lg block w-full hover:text-white">Toko
                        Rekanan</a>
                </li>
            </ul>
        </div>
