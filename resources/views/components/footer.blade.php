    ...
    <div class="container p-2 mx-auto">
        <div class="flex flex-col justify-between gap-3 md:flex-row">
            <div class="w-full md:w-1/3 md:h-[150px] flex items-center justify-start">
                <div class="w-4/6">
                    <img src="http://piesusudanin.test/asset/img/logo-leter.png" alt="">
                </div>
            </div>
            ...
            <div class="w-full md:w-1/3 md:h-[150px] flex items-center justify-center">
                <div class="footer_contact">
                    <span>Alamat :</span>
                    <p>Jl. Munasari No.mor 26, RT.1/RW.6, Pakintelan, Kec. Gn. Pati, Kota Semarang, Jawa Tengah
                        50227</p>
                </div>
            </div>
        </div>
...
<div class="w-full h-10 text-center bg-[brown] text-white flex items-center justify-center">
    &copy;2024 <a href="/">Pie Susu Danin</a>
</div>
