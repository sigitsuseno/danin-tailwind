<div>
    <section class="container px-2 py-3 mx-auto md:px-0">
        <div class="w-full h-[200px] md:h-[500px] overflow-hidden rounded-xl mb-3 md:mb-6 relative shadow-md">
            <img src="asset/img/pie-1.jpg" alt="" class="object-cover w-full h-full">
            <a href="piesusu.html"
                class="absolute top-0 left-0 p-3 text-xl text-white bg-opacity-50 rounded-br-xl lg:text-4xl lg:pb-5 bg-amber-400">Pie
                Susu</a>
        </div>
        <div class="w-full h-full gap-6 mt-5 md:flex">
            <div class="w-full h-[200px] md:w-1/2 md:h-[500px] overflow-hidden rounded-xl mb-3 relative shadow-md">
                <img src="asset/img/pie-1.jpg" alt="" class="object-cover w-full h-full">
                <a href="special.html"
                    class="absolute top-0 left-0 p-3 text-xl text-white bg-opacity-50 rounded-br-xl lg:text-4xl lg:pb-5 bg-amber-400">Special</a>
            </div>
            <div class="flex flex-col gap-6 md:w-1/2 md:h-[500px]">
                <div class="w-full h-[200px] md:h-full overflow-hidden rounded-xl relative shadow-md mt-3 md:mt-0">
                    <img src="http://piesusudanin.test/asset/img/roti_kering.jpg" alt=""
                        class="object-cover w-full h-full">
                    <a href="#"
                        class="absolute top-0 left-0 p-3 text-xl text-white bg-opacity-50 rounded-br-xl lg:text-4xl lg:pb-5 bg-amber-400">Roti
                        Kering</a>
                </div>
                <div class="w-full h-[200px] md:h-full overflow-hidden rounded-xl relative shadow-md">
                    <img src="http://piesusudanin.test/asset/img/jajanan.jpg" alt=""
                        class="object-cover w-full h-full">
                    <a href="#"
                        class="absolute top-0 left-0 p-3 text-xl text-white bg-opacity-50 rounded-br-xl lg:text-4xl lg:pb-5 bg-amber-400">Jajanan</a>
                </div>
            </div>
        </div>
        <div class="flex flex-col gap-6 mt-5 md:flex-row">
            <div class="w-full h-[200px] md:h-[300px]  overflow-hidden rounded-xl relative shadow-md">
                <img src="http://piesusudanin.test/asset/img/home.jpg" alt=""
                    class="object-cover w-full h-full">
                <a href="#"
                    class="absolute top-0 left-0 p-3 text-xl text-white bg-opacity-50 rounded-br-xl lg:text-4xl lg:pb-5 bg-amber-400">Danin
                    Store</a>
            </div>
            <div class="w-full h-[200px] md:h-[300px]  overflow-hidden rounded-xl relative shadow-md">
                <img src="http://piesusudanin.test/asset/img/home.jpg" alt=""
                    class="object-cover w-full h-full">
                <a href="#"
                    class="absolute top-0 left-0 p-3 text-xl text-white bg-opacity-50 rounded-br-xl lg:text-4xl lg:pb-5 bg-amber-400">Toko
                    Rekanan</a>
            </div>
        </div>
    </section>
